...
<body>
	...
	<div id="shadow">
		<!--form id='logon' name='logon'><-->
			...
			<div id="formDireita">
				<input type='hidden' id='classe' name='classe' value='Cliente'>
		...
		<div id="box">
			...
			<ul id='menu'> 
				<li><input type='submit' value='Alterar Cliente' class='linkSubmit'> </li>	
			</ul>
			<div id='formDireita'>				
					...
					<label for='cpf'>CPF: </label><BR><input type='text' name='cpf' size='30' maxlength='14' readonly onKeyUp='javascript:maskCPF(this.value)' readonly/> <BR>					
					...
					<label for='obs'>Observações:</label><BR> <textarea name='obs' id='obs' cols='50' rows='5'></textarea> <BR>
			</div>
			</form>	
		</div>
